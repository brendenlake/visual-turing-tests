	...
	// Handle a keypress by calling "func" on the actual string for the key
		
	// if a key with a character code is pressed, execute "func"
	// otherwise, do nothing
	tu.keyPress = function (e,func) {
	    var evtobj = window.event ? event : e; 
	    //distinguish between IE (window.event) and Firefox
	...
	// if an arrow key is pressed, call the function "func"
	// otherwise, do nothing
	tu.keyArrows = function (e,func) {
	    var evtobj= window.event ? event : e; 
	    var code = evtobj.keyCode;
	    var arrows = {left : 37, up : 38, right : 39, down : 40};
	    if (code === arrows.left) {
	       	func('left');		
	    }
	    else if (code === arrows.right) {
	        func('right');		
	    }
	    else if (code === arrows.up) {
	        func('up');		
	    }	
	    else if (code === arrows.down) {
	        func('down');		
	    }
	};
